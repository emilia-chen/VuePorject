<template>
  <div>
    <group title="single column" label-width="5em">
      <popup-picker :title="title1" :data="list1" v-model="value1" @on-show="onShow" @on-hide="onHide" @on-change="onChange" @on-shadow-change="shadowChange" :placeholder="$t('please select')"></popup-picker>
    ...
    <div class="picker-buttons">
     ...
     <group title="chained columns">
       <popup-picker :title="title3" :data="list3" :columns="3" v-model="value3" ref="picker3" @on-change="onChange"></popup-picker>
...
export default {
 ...
 console.log('ids change', ids)
    console.log('names change', names)
    },
     changeList21 () {
      this.list3.push({
        name: '美国002_007',
