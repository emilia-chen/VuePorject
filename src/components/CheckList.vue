<template>
  <div>
    <checklist :title="$t('Basic Usage')" :label-position="labelPosition" required :options="commonList" v-model="checklist001" @on-change="change" :max="1" :min="1">

   <button slot="">你好</button>
  <div>那沙发大发发</div>
  <div>那沙发大发发</div>
    </checklist>
