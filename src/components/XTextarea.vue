<template>
  <div>
    ...
    <group :title="$t('autosize')">
      <x-textarea :placeholder="$t('Type something')" :show-counter="false" :rows="8"  :cols="10" autosize>
       </x-textarea>
      <x-textarea :title="$t('title')" :placeholder="$t('Type something')" :show-counter="false" :rows="1" autosize>
      </x-textarea>
    </group>
